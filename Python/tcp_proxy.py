...
def receive_from(connection):
    ...
    # we set a 2 second timeout; adjust as needed
...
def request_handlder(buffer):
    # perform packet stuff
    return buffer
...
def main():
    ...
    if len(sys.argv[1:]) != 5:
        ...
        print "Example: ./tcp_proxy.py 127.0.0.1 9000 10.12.96.18 9000 True"
        sys.exit(0)
